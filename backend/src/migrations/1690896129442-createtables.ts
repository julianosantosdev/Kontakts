...
export class Createtables1690896129442 implements MigrationInterface {
    name = 'Createtables1690896129442'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "fullName" ("id" SERIAL NOT NULL, "fullName" character varying(50) NOT NULL, "createdAt" date NOT NULL DEFAULT now(), "contactId" integer, CONSTRAINT "REL_c106c574676681d98fd75a5241" UNIQUE ("contactId"), CONSTRAINT "PK_70ddd61e932d96c9ce25785c326" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "contacts" ("id" SERIAL NOT NULL, "createdAt" date NOT NULL DEFAULT now(), "userId" integer, CONSTRAINT "PK_b99cd40cfd66a99f1571f4f72e6" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "fullName" ADD CONSTRAINT "FK_c106c574676681d98fd75a52416" FOREIGN KEY ("contactId") REFERENCES "contacts"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "addresses" ADD CONSTRAINT "FK_4b3866faeb7c87d481e073fc7cd" FOREIGN KEY ("contactId") REFERENCES "contacts"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "addresses" DROP CONSTRAINT "FK_4b3866faeb7c87d481e073fc7cd"`);
        await queryRunner.query(`ALTER TABLE "contacts" DROP CONSTRAINT "FK_30ef77942fc8c05fcb829dcc61d"`);
        await queryRunner.query(`ALTER TABLE "fullName" DROP CONSTRAINT "FK_c106c574676681d98fd75a52416"`);
